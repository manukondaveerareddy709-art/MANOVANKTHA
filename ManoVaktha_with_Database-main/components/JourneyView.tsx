...
// --- Sound Effects ---
const sendSound = 'data:audio/mpeg;base64,.98.4UUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUU...';
...
const JourneyView: React.FC<JourneyViewProps> = ({ initialProblem: initialProblemFromProps = '' }) => {
    ...
    const handleSendMessage = async (e: FormEvent) => {
        ...
        try {
            ...
            const responseStream = streamMessageToExpert(historyForApi, trimmedInput, language, currentJourneyState);
